...
@test "2.5.1 strtie/tlheghrar" {
  ...
  compare_e "bar 0 bar strtie" "bar0bar"
  ...
  compare_f "foo bar tlheghrar" "foobar"
  compare_f "1 bar tlheghrar" "1bar"
  compare_f "0 bar tlheghrar" "0bar"
  compare_f "bar 0 tlheghrar" "bar0"
  compare_f "bar 1 tlheghrar" "bar1"
  compare_f "bar 0 bar tlheghrar" "bar0bar"
}
